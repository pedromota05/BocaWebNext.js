...
export const Cabecalho = ({busca, buscaODA, lista}) => {
  ...
  //Imagens Carousel
  var prof_boca=require('../pages/img/bocaweb.PNG');
  var introducao=require('../pages/img/ad_blog.jpg');
  var historia=require('../pages/img/12.png');
  var crianca=require('../pages/img/crianca.png');
  var netflix=require('../pages/img/netflix.jpg');
  var isolamento=require('../pages/img/isolamento.jpg');
    return(
      <div lang="pt-br">
      <Head>
      ...
      {/*HTML - Sidebar/Navbar*/}
        ...
        <div className="logo-details">
          <div className='logoboca-navbar' alt="Logo BocaWeb" />
      ...
      <section className="home-section">
        <nav>
          ...
          <div className="profile-details">
            <div className="pedro" alt="Imagem Pedro Mota"/>
      ...
      <div className="breaking_news d-flex justify-content-center">
          <div className="label ripple">Últimas ODAS</div>
          <marquee behavior='scroll' width='50%' scrollamount='10' direction='left'>
            {lista.length > 0 && <div className="news_title border-0">
            <span className="dot"></span> Nome: {lista[lista.length-1].nome} - Usuário: {lista[lista.length-1].usuario} 
            <span className="dot"></span> Nome: {lista[lista.length-2].nome} - Usuário: {lista[lista.length-2].usuario} 
            <span className="dot"></span> Nome: {lista[lista.length-3].nome} - Usuário: {lista[lista.length-3].usuario}</div> 
            }
            </marquee>
      </div>
                                ...
                                <div className="carousel-item active">
                                    <div className="card border-0 rounded-0 text-light overflow zoom">
                                        <div className="position-relative">
                                            <div className="ratio_left-cover-1 image-wrapper" style={{background: '#f5f5f5'}}>
                                                <a href="#!">
                                                    <Image className="img-fluid w-100 images-carousel" src={prof_boca} 
                                                    width="700%" height="525px"
                                                    alt="Professor Ricardo apresentando o projeto BocaWeb"/>
                                                </a>
                                            </div>
                                ...
                                <div className="carousel-item">
                                    <div className="card border-0 rounded-0 text-light overflow zoom">
                                        <div className="position-relative">
                                            <div className="ratio_left-cover-1 image-wrapper" style={{background: '#f5f5f5'}}>
                                                <a href="#!">
                                                    <Image className="img-fluid w-100 images-carousel" width="700%" height="525px"
                                                    src={introducao} alt="something"/>
                                                </a>
                                            </div>
                                            <div className="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                        ...
                        <div className="row">
                            <div className="col-6 pb-1 pt-0 pr-1">
                                <div className="card border-0 rounded-0 text-white overflow zoom">
                                    <div className="position-relative">
                                        <div className="ratio_right-cover-2 image-wrapper" style={{background: '#f5f5f5'}}>
                                            <a href="#!">
                                                <Image className="img-fluid images-lateral" width="342%" height="259px"
                                                src={historia} alt="something"/>
                                            </a>
                                        </div>
                                        <div className="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                            ...
                            <div className="col-6 pb-1 pl-1 pt-0">
                                <div className="card border-0 rounded-0 text-white overflow zoom">
                                    <div className="position-relative">
                                        <div className="ratio_right-cover-2 image-wrapper" style={{background: '#f5f5f5'}}>
                                            <a href="#!">
                                                <Image className="img-fluid images-lateral" src={crianca} width="342%" height="259px"
                                                alt="something"/>
                                            </a>
                                        </div>
                                        <div className="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                            ...
                            <div className="col-6 pb-1 pr-1 pt-1">
                                <div className="card border-0 rounded-0 text-white overflow zoom">
                                    <div className="position-relative">
                                        <div className="ratio_right-cover-2 image-wrapper" style={{background: '#f5f5f5'}}>
                                            <a href="#!">
                                                <Image className="img-fluid images-lateral" src={netflix} width="342%" height="259px"
                                                alt="something"/>
                                            </a>
                                        </div>
                                        <div className="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                            ...
                            <div className="col-6 pb-1 pl-1 pt-1">
                                <div className="card border-0 rounded-0 text-white overflow zoom">
                                    <div className="position-relative">
                                        <div className="ratio_right-cover-2 image-wrapper" style={{background: '#f5f5f5'}}>
                                            <a href="#!">
                                                <Image className="img-fluid images-lateral" src={isolamento} width="342%" height="259px"
                                                alt="something"/>
                                            </a>
                                        </div>
                                        <div className="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
          ...
          <footer>
           <div className="footer-wrap">
              ...
              <div className="second_class">
                 ...
                 <div className="row">
                    <div>
                       <div className="footer-logo d-flex justify-content-center"><div className='logoboca-footer' alt="logo BocaWeb"/>
                       </div>
